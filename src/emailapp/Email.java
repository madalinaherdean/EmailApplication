...
public class Email {
    ...
    //Setting variable as private to not give directly
    ...
    public Email(String fname, String lname){
        ...
        this.password=generate_password(8);//Password
        this.email=this.gerenarte_email();//email generation


    }
    //Generate mail method
    private String gerenarte_email(){
...
//set mailbox capacity method
    ...
    public void storefile(){
        try {
            FileWriter in = new FileWriter("C:\\Users\\admin\\IdeaProjects\\info.txt");
    ...
    public void read_file() {
        try {
            ...
            FileReader f1 = new FileReader("C:\\Users\\admin\\IdeaProjects\\info.txt");
            int i;
            while ((i = f1.read()) != -1) {
